...
<body>
    ...
    <ul>
        <li>
            <a href="#QuartaEntrega">A quarta entrega</a>
            <ul>
    ...
    - Gerar documento Full </br>
    - Disponibilizr donwload da LEP
    <h3 id="quais-foram-as-partes-mais-trabalhosas">Quais foram as partes mais trabalhosas?</h3>
    <p align="justify">
        Para esta entrega, as maiores dificuldades foram conseguir realizar o arquivo FULL e disponibilizar o download da LEP
    </p> <br/>
    <h2 align="center" id="funcionamento">Nosso sistema em funcionamento até o momento :computer:</h2>
    <p align="center">
    <h3> - Disponibilização de download da LEP </h3> <br/>
